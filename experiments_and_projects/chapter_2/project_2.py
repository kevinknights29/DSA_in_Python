# Modify the method in the chapter_2/project_1.py file, so that the item
# with the maximum value is not only returned but also removed from the array.
# call the method delete_max_num().
...
if __name__ == "__main__":
    ...
    arr_1.insert(2)
    arr_1.insert(3)
    assert arr_1.delete_max_num() == 3 and len(arr_1) == 2
    ...
    # arr_2.insert("b")
    # arr_2.insert("c")
    # assert arr_2.delete_max_num() is ValueError and len(arr_2) == 3
    ...
    arr_3.insert(1)
    arr_3.insert("c")
    assert arr_3.delete_max_num() == 1 and len(arr_3) == 2
